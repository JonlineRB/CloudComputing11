...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      {method: 'GET', path: '/api/exercise2', description: 'group 11 application deployed using docker'},
...
app.get('/api/profile', (req, res) => {
  res.json({
    'name': 'Mario',
    'homeCountry': 'Mushroom Kingdom',
    'degreeProgram': 'Applied Plumbing Sciences',//informatics or CSE.. etc
    'email': 'mario@mushmail.net',
    'deployedURLLink': '',//leave this blank for the first exercise
    'apiDocumentationURL': '', //leave this also blank for the first exercise
    'currentCity': 'NA',
    'hobbies': ['Kart racing', 'Golf', 'Tennis', 'Olympics', 'Party', 'Video games']
